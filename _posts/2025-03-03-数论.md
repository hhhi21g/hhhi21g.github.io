...
- 使用**扩展欧几里得算法**：
  ...
  - 欧几里得算法，递归部分的核心如下：
    ...
    <p align="center">
	      <img src="https://hhhi21g.github.io/public/img/math/m6.png" alt="alt text" style="zoom:70%;" />
	  </p>
  
  - 扩展欧几里得算法: 根据裴蜀定理，带入欧几里得算法变式可得：
  
    <p align="center">
        <img src="https://hhhi21g.github.io/public/img/math/m7.png" alt="alt text" style="zoom:70%;" />
    </p>
  
    <p align="center">
        <img src="https://hhhi21g.github.io/public/img/math/m8.png" alt="alt text" style="zoom:70%;" />
    </p>
