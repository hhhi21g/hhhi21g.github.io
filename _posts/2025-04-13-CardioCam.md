...
- 选择具有**最大归一化方差**的前k个主成分，称为**心脏摘要(cardiac abstracts)**;
  ...
  - 因此，**舍弃前两个主成分**，从第三个主成分开始进行主成分选择过程，公式如下：
    ...
    <p align="center">
        <img src="https://hhhi21g.github.io/public/img/xinan/x0.png" alt="alt text" style="zoom:67%;" />
    </p>
...
- 计算每个s和F之间的**平均欧几里得距离**：
  ...
  <p align="center">
      <img src="https://hhhi21g.github.io/public/img/xinan/x1.png" alt="alt text" style="zoom:67%;" />
  </p>
...
- 使用**阈值*η***，Dist(s)<= η, 则通过认证；
  ...
  - 使用**Youden's J统计量进行评分**，通过递归计算不同阈值η 对应的J统计量，选择使得J统计量最大化的阈值η<sub>u</sub>
    ...
    <p align="center">
        <img src="https://hhhi21g.github.io/public/img/xinan/x2.png" alt="alt text" style="zoom:67%;" />
    </p>
